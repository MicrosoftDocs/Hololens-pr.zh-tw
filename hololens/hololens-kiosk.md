...
1. <span data-ttu-id="d459d-128">**哪些應用程式 () 將會在您的 Kiosk 中？**</span><span class="sxs-lookup"><span data-stu-id="d459d-128">**Which app(s) will be in your Kiosk?**</span></span> <span data-ttu-id="d459d-129">請使用下方的 Aumid 清單來新增任何 In-Box 應用程式，以及您自己的應用程式。</span><span class="sxs-lookup"><span data-stu-id="d459d-129">Please use our list of AUMIDs below to add any In-Box apps in addition to your own.</span></span>
...
### <a name="decide-between-a-single-app-kiosk-or-a-multi-app-kiosk"></a><span data-ttu-id="d459d-144">在單一應用程式 kiosk 或多應用程式 kiosk 之間決定</span><span class="sxs-lookup"><span data-stu-id="d459d-144">Decide between a single-app kiosk or a multi-app kiosk</span></span>
...
<span data-ttu-id="d459d-177">下表列出不同 kiosk 模式的使用者支援功能。</span><span class="sxs-lookup"><span data-stu-id="d459d-177">The following table lists the user support features of the different kiosk modes.</span></span>
...
|<span data-ttu-id="d459d-232">舊 Microsoft Edge</span><span class="sxs-lookup"><span data-stu-id="d459d-232">Old Microsoft Edge</span></span> |<span data-ttu-id="d459d-233">Microsoft.MicrosoftEdge_8wekyb3d8bbwe!MicrosoftEdge</span><span class="sxs-lookup"><span data-stu-id="d459d-233">Microsoft.MicrosoftEdge_8wekyb3d8bbwe!MicrosoftEdge</span></span> |
...
### <a name="select-a-deployment-method"></a><span data-ttu-id="d459d-278">選取部署方法</span><span class="sxs-lookup"><span data-stu-id="d459d-278">Select a deployment method</span></span>
...
### <a name="mdm-step-2-ndash-create-a-kiosk-configuration-profile"></a><a id="mdmprofile"></a><span data-ttu-id="d459d-335">MDM，步驟2： &ndash; 建立 kiosk 設定檔</span><span class="sxs-lookup"><span data-stu-id="d459d-335">MDM, step 2 &ndash; Create a kiosk configuration profile</span></span>
...
<span data-ttu-id="d459d-350">本節摘要說明單一應用程式 kiosk 需要的設定。</span><span class="sxs-lookup"><span data-stu-id="d459d-350">This section summarizes the settings that a single-app kiosk requires.</span></span> <span data-ttu-id="d459d-351">如需詳細資訊，請參閱下列文章：</span><span class="sxs-lookup"><span data-stu-id="d459d-351">For more details, see the following articles:</span></span>
...
### <a name="provisioning-package-step-1-ndash-create-a-kiosk-configuration-xml-file"></a><a id="ppkioskconfig"></a><span data-ttu-id="d459d-412">布建套件，步驟1： &ndash; 建立 kiosk 設定 XML 檔案</span><span class="sxs-lookup"><span data-stu-id="d459d-412">Provisioning package, step 1 &ndash; Create a kiosk configuration XML file</span></span>
...
<span data-ttu-id="d459d-424">組建 Windows 全像[21H1 版](hololens-release-notes.md#windows-holographic-version-21h1)和更新版本：</span><span class="sxs-lookup"><span data-stu-id="d459d-424">On builds [Windows Holographic, version 21H1](hololens-release-notes.md#windows-holographic-version-21h1) and onwards:</span></span>
...
<span data-ttu-id="d459d-444">如果您使用布建 [套件](#use-a-provisioning-package-to-set-up-a-single-app-or-multi-app-kiosk) 來設定多應用程式 kiosk，程式就需要 [開始] 版面配置。</span><span class="sxs-lookup"><span data-stu-id="d459d-444">If you use a [provisioning package](#use-a-provisioning-package-to-set-up-a-single-app-or-multi-app-kiosk) to configure a multi-app kiosk, the procedure requires a Start layout.</span></span> <span data-ttu-id="d459d-445">Windows Holographic for Business 不支援開始配置自訂。</span><span class="sxs-lookup"><span data-stu-id="d459d-445">Start layout customization isn't supported in Windows Holographic for Business.</span></span> <span data-ttu-id="d459d-446">因此，您必須使用預留位置開始版面配置。</span><span class="sxs-lookup"><span data-stu-id="d459d-446">Therefore, you'll have to use a placeholder Start layout.</span></span>
...
> [!NOTE]  
> <span data-ttu-id="d459d-448">如果您使用 [MDM](#use-microsoft-intune-or-other-mdm-to-set-up-a-single-app-or-multi-app-kiosk) 來設定多應用程式 kiosk，則可以選擇性地使用 [開始] 版面配置。</span><span class="sxs-lookup"><span data-stu-id="d459d-448">If you use [MDM](#use-microsoft-intune-or-other-mdm-to-set-up-a-single-app-or-multi-app-kiosk) to set up a multi-app kiosk, you can optionally use a Start layout.</span></span> <span data-ttu-id="d459d-449">如需詳細資訊，請參閱 [適用于 MDM (Intune 和其他) 的預留位置開始 ](#start-layout-file-for-mdm-intune-and-others)配置檔案。</span><span class="sxs-lookup"><span data-stu-id="d459d-449">For more information, see [Placeholder Start layout file for MDM (Intune and others)](#start-layout-file-for-mdm-intune-and-others).</span></span>

<span data-ttu-id="d459d-450">在 [開始] 配置中，將下列 **StartLayout** 區段新增至 kiosk 布建 XML 檔案：</span><span class="sxs-lookup"><span data-stu-id="d459d-450">For the Start layout, add the following **StartLayout** section to the kiosk provisioning XML file:</span></span>
...
#### <a name="placeholder-start-layout-file-for-mdm-intune-and-others"></a><a id="start-layout-file-for-mdm-intune-and-others"></a><span data-ttu-id="d459d-451">MDM (Intune 和其他) 的預留位置開始設定檔案</span><span class="sxs-lookup"><span data-stu-id="d459d-451">Placeholder Start layout file for MDM (Intune and others)</span></span>

<span data-ttu-id="d459d-452">將下列範例儲存為 XML 檔案。</span><span class="sxs-lookup"><span data-stu-id="d459d-452">Save the following sample as an XML file.</span></span> <span data-ttu-id="d459d-453">當您在 Microsoft Intune (或另一個提供 kiosk 設定檔) 的 MDM 服務中設定多應用程式 kiosk 時，可以使用這個檔案。</span><span class="sxs-lookup"><span data-stu-id="d459d-453">You can use this file when you configure the multi-app kiosk in Microsoft Intune (or in another MDM service that provides a kiosk profile).</span></span>

> [!NOTE]
> <span data-ttu-id="d459d-454">如果您必須使用自訂設定和完整 XML 設定來設定 MDM 服務中的 kiosk，請使用布建 [套件的「開始配置」指示](#start-layout-for-hololens)。</span><span class="sxs-lookup"><span data-stu-id="d459d-454">If you have to use a custom setting and full XML configuration to set up a kiosk in your MDM service, use the [Start layout instructions for a provisioning package](#start-layout-for-hololens).</span></span>
...
### <a name="prov-package-step-2-ndash-add-the-kiosk-configuration-xml-file-to-a-provisioning-package"></a><a id="ppconfigadd"></a><span data-ttu-id="d459d-455">箴。</span><span class="sxs-lookup"><span data-stu-id="d459d-455">Prov.</span></span> <span data-ttu-id="d459d-456">封裝，步驟 2 &ndash; 將 kiosk 設定 XML 檔案新增至布建套件</span><span class="sxs-lookup"><span data-stu-id="d459d-456">package, step 2 &ndash; Add the kiosk configuration XML file to a provisioning package</span></span>

1. <span data-ttu-id="d459d-457">開啟[Windows 設定設計](https://www.microsoft.com/store/apps/9nblggh4tx22)工具]。</span><span class="sxs-lookup"><span data-stu-id="d459d-457">Open [Windows Configuration Designer](https://www.microsoft.com/store/apps/9nblggh4tx22).</span></span>
1. <span data-ttu-id="d459d-458">選取 [ **Advanced** 布建]，輸入專案的名稱，然後選取 **[下一步]**。</span><span class="sxs-lookup"><span data-stu-id="d459d-458">Select **Advanced provisioning**, enter a name for your project, and then select **Next**.</span></span>
1. <span data-ttu-id="d459d-459">選取 **Windows 10 全像攝影版**，然後選取 **[下一步]**。</span><span class="sxs-lookup"><span data-stu-id="d459d-459">Select **Windows 10 Holographic**, and then select **Next**.</span></span>
1. <span data-ttu-id="d459d-460">選取 [完成]。</span><span class="sxs-lookup"><span data-stu-id="d459d-460">Select **Finish**.</span></span> <span data-ttu-id="d459d-461">套件的工作區就會開啟。</span><span class="sxs-lookup"><span data-stu-id="d459d-461">The workspace for your package opens.</span></span>
1. <span data-ttu-id="d459d-462">選取 [**執行時間設定**  >  **>assignedaccess**  >  **MultiAppAssignedAccessSettings**]。</span><span class="sxs-lookup"><span data-stu-id="d459d-462">Select **Runtime settings** > **AssignedAccess** > **MultiAppAssignedAccessSettings**.</span></span>
1. <span data-ttu-id="d459d-463">在中央窗格中，選取 **[流覽]** 以找出並選取您建立的 KIOSK 設定 XML 檔案。</span><span class="sxs-lookup"><span data-stu-id="d459d-463">In the center pane, select **Browse** to locate and select the kiosk configuration XML file that you created.</span></span>

   ![Windows 設定設計工具中 MultiAppAssignedAccessSettings 欄位的螢幕擷取畫面](./images/multiappassignedaccesssettings.png)

1. <span data-ttu-id="d459d-465">**選擇項**。</span><span class="sxs-lookup"><span data-stu-id="d459d-465">**Optional**.</span></span> <span data-ttu-id="d459d-466"> (如果您要在初始設定裝置之後套用布建套件，且 kiosk 裝置上已有可用的系統管理使用者，請略過此步驟。 ) 選取 [ **執行時間設定** &gt; **帳戶** &gt; **使用者**]，然後建立使用者帳戶。</span><span class="sxs-lookup"><span data-stu-id="d459d-466">(If you want to apply the provisioning package after the initial setup of the device, and there is an admin user already available on the kiosk device, skip this step.) Select **Runtime settings** &gt; **Accounts** &gt; **Users**, and then create a user account.</span></span> <span data-ttu-id="d459d-467">提供 [使用者名稱] 和 [密碼]，然後選取 [ **UserGroup** 系統  >  **管理員**]。</span><span class="sxs-lookup"><span data-stu-id="d459d-467">Provide a user name and password, and then select **UserGroup** > **Administrators**.</span></span>  
  
     <span data-ttu-id="d459d-468">您可以使用此帳戶來查看布建狀態和記錄。</span><span class="sxs-lookup"><span data-stu-id="d459d-468">By using this account, you can view the provisioning status and logs.</span></span>  
1. <span data-ttu-id="d459d-469">**選擇項**。</span><span class="sxs-lookup"><span data-stu-id="d459d-469">**Optional**.</span></span> <span data-ttu-id="d459d-470"> (如果您在 kiosk 裝置上已經有非系統管理員帳戶，請略過此步驟。 ) 選取 [ **執行時間設定** &gt; **帳戶** &gt; **使用者**]，然後建立本機使用者帳戶。</span><span class="sxs-lookup"><span data-stu-id="d459d-470">(If you already have a non-admin account on the kiosk device, skip this step.) Select **Runtime settings** &gt; **Accounts** &gt; **Users**, and then create a local user account.</span></span> <span data-ttu-id="d459d-471">請確定使用者名稱與您在設定 XML 中指定的帳號相同。</span><span class="sxs-lookup"><span data-stu-id="d459d-471">Make sure that the user name is the same as for the account that you specify in the configuration XML.</span></span> <span data-ttu-id="d459d-472">選取 [ **UserGroup**  >  **標準使用者**]。</span><span class="sxs-lookup"><span data-stu-id="d459d-472">Select **UserGroup** > **Standard Users**.</span></span>
1. <span data-ttu-id="d459d-473">選取 **[**  >  **儲存** 盤案]。</span><span class="sxs-lookup"><span data-stu-id="d459d-473">Select **File** > **Save**.</span></span>
1. <span data-ttu-id="d459d-474">選取 [**匯出** 布建  >  **套件**]，然後選取 [**擁有** 者  >  **IT 系統管理員**]。這會設定此布建套件的優先順序，高於從其他來源套用到此裝置的布建套件。</span><span class="sxs-lookup"><span data-stu-id="d459d-474">Select **Export** > **Provisioning package**, and then select **Owner** > **IT Admin**. This sets the precedence of this provisioning package higher than provisioning packages that are applied to this device from other sources.</span></span>
1. <span data-ttu-id="d459d-475">選取 [下一步] 。</span><span class="sxs-lookup"><span data-stu-id="d459d-475">Select **Next**.</span></span>
1. <span data-ttu-id="d459d-476">在 [布建 **套件安全性** ] 頁面上，選取安全性選項。</span><span class="sxs-lookup"><span data-stu-id="d459d-476">On the **Provisioning package security** page, select a security option.</span></span>
   > [!IMPORTANT]  
   > <span data-ttu-id="d459d-477">如果您選取 [ **啟用套件簽署**]，則也必須選取要用於簽署封裝的有效憑證。</span><span class="sxs-lookup"><span data-stu-id="d459d-477">If you select **Enable package signing**, you also have to select a valid certificate to use for signing the package.</span></span> <span data-ttu-id="d459d-478">若要這樣做，請選取 **[流覽]** ，然後選取您要用來簽署封裝的憑證。</span><span class="sxs-lookup"><span data-stu-id="d459d-478">To do this, select **Browse** and select the certificate that you want to use to sign the package.</span></span>
   
   > [!CAUTION]  
   > <span data-ttu-id="d459d-479">請勿選取 [ **啟用套件加密**]。</span><span class="sxs-lookup"><span data-stu-id="d459d-479">Do not select **Enable package encryption**.</span></span> <span data-ttu-id="d459d-480">在 HoloLens 裝置上，此設定會導致布建失敗。</span><span class="sxs-lookup"><span data-stu-id="d459d-480">On HoloLens devices, this setting causes provisioning to fail.</span></span>
1. <span data-ttu-id="d459d-481">選取 [下一步] 。</span><span class="sxs-lookup"><span data-stu-id="d459d-481">Select **Next**.</span></span>
1. <span data-ttu-id="d459d-482">指定您要在建立布建套件的輸出位置。</span><span class="sxs-lookup"><span data-stu-id="d459d-482">Specify the output location where you want the provisioning package to go when it's built.</span></span> <span data-ttu-id="d459d-483">Windows 設定設計工具預設會使用專案資料夾做為輸出位置。</span><span class="sxs-lookup"><span data-stu-id="d459d-483">By default, Windows Configuration Designer uses the project folder as the output location.</span></span> <span data-ttu-id="d459d-484">如果您想要變更輸出位置，請選取 **[流覽]**。</span><span class="sxs-lookup"><span data-stu-id="d459d-484">If you want to change the output location, select **Browse**.</span></span> <span data-ttu-id="d459d-485">完成後，選取 [下一步] 。</span><span class="sxs-lookup"><span data-stu-id="d459d-485">When you are finished, select **Next**.</span></span>
1. <span data-ttu-id="d459d-486">選取 [ **建立** ] 以開始建立套件。</span><span class="sxs-lookup"><span data-stu-id="d459d-486">Select **Build** to start building the package.</span></span> <span data-ttu-id="d459d-487">建置佈建套件並不需要很長的時間。</span><span class="sxs-lookup"><span data-stu-id="d459d-487">The provisioning package doesn't take long to build.</span></span> <span data-ttu-id="d459d-488">[組建] 頁面會顯示專案資訊，而進度列會指出組建狀態。</span><span class="sxs-lookup"><span data-stu-id="d459d-488">The build page displays the project information, and the progress bar indicates the build status.</span></span>

### <a name="provisioning-package-step-3-ndash-apply-the-provisioning-package-to-hololens"></a><a id="ppapply"></a><span data-ttu-id="d459d-489">布建套件，步驟3將布建 &ndash; 套件套用至 HoloLens</span><span class="sxs-lookup"><span data-stu-id="d459d-489">Provisioning package, step 3 &ndash; Apply the provisioning package to HoloLens</span></span>

<span data-ttu-id="d459d-490">「使用布建套件設定 HoloLens」一文提供在下列情況下套用布建套件的詳細指示：</span><span class="sxs-lookup"><span data-stu-id="d459d-490">The "Configure HoloLens by using a provisioning package" article provides detailed instructions to apply the provisioning package under the following circumstances:</span></span>

- <span data-ttu-id="d459d-491">您一開始可以在[安裝期間將布建套件套用至 HoloLens](hololens-provisioning.md#apply-a-provisioning-package-to-hololens-during-setup)。</span><span class="sxs-lookup"><span data-stu-id="d459d-491">You can initially [apply a provisioning package to HoloLens during setup](hololens-provisioning.md#apply-a-provisioning-package-to-hololens-during-setup).</span></span>

- <span data-ttu-id="d459d-492">您也可以在[安裝之後，將布建套件套用至 HoloLens](hololens-provisioning.md#applyremove-a-provisioning-package-to-hololens-after-setup)。</span><span class="sxs-lookup"><span data-stu-id="d459d-492">You can also [apply a provisioning package to HoloLens after setup](hololens-provisioning.md#applyremove-a-provisioning-package-to-hololens-after-setup).</span></span>

## <a name="use-the-windows-device-portal-to-set-up-a-single-app-kiosk"></a><span data-ttu-id="d459d-493">使用 Windows 裝置入口網站來設定單一應用程式 kiosk</span><span class="sxs-lookup"><span data-stu-id="d459d-493">Use the Windows Device Portal to set up a single-app kiosk</span></span>

<span data-ttu-id="d459d-494">若要使用 Windows 裝置入口網站設定 kiosk 模式，請遵循下列步驟。</span><span class="sxs-lookup"><span data-stu-id="d459d-494">To set up kiosk mode by using the Windows Device Portal, follow these steps.</span></span>

1. <span data-ttu-id="d459d-495">[設定 HoloLens 裝置以使用 Windows 裝置入口網站](https://developer.microsoft.com/windows/mixed-reality/using_the_windows_device_portal#setting_up_hololens_to_use_windows_device_portal)。</span><span class="sxs-lookup"><span data-stu-id="d459d-495">[Set up the HoloLens device to use the Windows Device Portal](https://developer.microsoft.com/windows/mixed-reality/using_the_windows_device_portal#setting_up_hololens_to_use_windows_device_portal).</span></span> <span data-ttu-id="d459d-496">Device Portal 是您 HoloLens 上的網頁伺服器，您可以從電腦上的網頁瀏覽器與它連線。</span><span class="sxs-lookup"><span data-stu-id="d459d-496">The Device Portal is a web server on your HoloLens that you can connect to from a web browser on your PC.</span></span>

    > [!CAUTION]
    > <span data-ttu-id="d459d-497">當您設定 HoloLens 使用裝置入口網站時，您必須在裝置上啟用開發人員模式。</span><span class="sxs-lookup"><span data-stu-id="d459d-497">When you set up HoloLens to use the Device Portal, you have to enable Developer Mode on the device.</span></span> <span data-ttu-id="d459d-498">具有 Windows Holographic for Business 的裝置上的開發人員模式，可讓您側載應用程式。</span><span class="sxs-lookup"><span data-stu-id="d459d-498">Developer Mode on a device that has Windows Holographic for Business enables you to side-load apps.</span></span> <span data-ttu-id="d459d-499">不過，此設定會產生一個風險，讓使用者可以安裝尚未通過 Microsoft Store 認證的應用程式。</span><span class="sxs-lookup"><span data-stu-id="d459d-499">However, this setting creates a risk that a user can install apps that have not been certified by the Microsoft Store.</span></span> <span data-ttu-id="d459d-500">系統管理員可以使用 [原則 CSP](/windows/client-management/mdm/policy-configuration-service-provider)中的 **ApplicationManagement/AllowDeveloper Unlock** 設定，封鎖啟用開發人員模式的能力。</span><span class="sxs-lookup"><span data-stu-id="d459d-500">Administrators can block the ability to enable Developer Mode by using the **ApplicationManagement/AllowDeveloper Unlock** setting in the [Policy CSP](/windows/client-management/mdm/policy-configuration-service-provider).</span></span> [<span data-ttu-id="d459d-501">深入了解開發人員模式。</span><span class="sxs-lookup"><span data-stu-id="d459d-501">Learn more about Developer Mode.</span></span>](/windows/uwp/get-started/enable-your-device-for-development#developer-mode)
    
1. <span data-ttu-id="d459d-502">在電腦上，使用[wi-fi](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#connecting_over_wi-fi)或[USB](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#connecting_over_usb)連接到 HoloLens。</span><span class="sxs-lookup"><span data-stu-id="d459d-502">On a computer, connect to the HoloLens by using [Wi-Fi](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#connecting_over_wi-fi) or [USB](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#connecting_over_usb).</span></span>

1. <span data-ttu-id="d459d-503">執行下列其中一個動作：</span><span class="sxs-lookup"><span data-stu-id="d459d-503">Do one of the following:</span></span>
   - <span data-ttu-id="d459d-504">如果您是第一次連接到 Windows 裝置入口網站，請[建立使用者名稱和密碼](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#creating_a_username_and_password)</span><span class="sxs-lookup"><span data-stu-id="d459d-504">If you are connecting to the Windows Device Portal for the first time, [create a user name and password](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#creating_a_username_and_password)</span></span>
   - <span data-ttu-id="d459d-505">輸入您先前設定的使用者名稱和密碼。</span><span class="sxs-lookup"><span data-stu-id="d459d-505">Enter the user name and password that you previously set up.</span></span>

    > [!TIP]
    > <span data-ttu-id="d459d-506">如果您在瀏覽器中看到憑證有誤，請遵循[下列疑難排解步驟](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#security_certificate)。</span><span class="sxs-lookup"><span data-stu-id="d459d-506">If you see a certificate error in the browser, follow [these troubleshooting steps](https://developer.microsoft.com/windows/mixed-reality/Using_the_Windows_Device_Portal#security_certificate).</span></span>

1. <span data-ttu-id="d459d-507">在 [Windows 裝置入口網站中，選取 [ **Kiosk 模式]**。</span><span class="sxs-lookup"><span data-stu-id="d459d-507">In the Windows Device Portal, select **Kiosk Mode**.</span></span>

1. <span data-ttu-id="d459d-508">選取 [ **啟用 Kiosk 模式]**，選取裝置啟動時要執行的應用程式，然後選取 [ **儲存**]。</span><span class="sxs-lookup"><span data-stu-id="d459d-508">Select **Enable Kiosk Mode**, select an app to run when the device starts, and then select **Save**.</span></span>

    ![Kiosk 模式](images/kiosk.png)
1. <span data-ttu-id="d459d-510&quot;>重新開機 HoloLens。</span><span class=&quot;sxs-lookup&quot;><span data-stu-id=&quot;d459d-510&quot;>Restart HoloLens.</span></span> <span data-ttu-id=&quot;d459d-511&quot;>如果您仍然開啟裝置入口網站頁面，可以選取頁面頂端的 [ **重新開機** ]。</span><span class=&quot;sxs-lookup&quot;><span data-stu-id=&quot;d459d-511&quot;>If you still have your Device Portal page open, you can select **Restart** at the top of the page.</span></span>

> [!NOTE]
> <span data-ttu-id=&quot;d459d-512&quot;>您可以透過裝置入口網站的 REST API 來設定 Kiosk 模式，方法是使用一個必要的查詢字串參數來設定 &quot;kioskModeEnabled&quot; ( &quot;&quot; 的值為 &quot;true&quot; 或 &quot;false" ) 以及一個選擇性參數 ( "startupApp" 值為套件名稱) 。</span><span class="sxs-lookup"><span data-stu-id="d459d-512">Kiosk Mode can be set via Device Portal’s REST API by doing a POST to /api/holographic/kioskmode/settings with one required query string parameter (“kioskModeEnabled” with a value of “true” or “false”) and one optional parameter (“startupApp” with a value of a package name).</span></span> <span data-ttu-id="d459d-513">請記住，裝置入口網站僅適用于開發人員，不應在非開發人員裝置上啟用。</span><span class="sxs-lookup"><span data-stu-id="d459d-513">Please keep in mind that Device Portal is intended for developers only and should not be enabled on non-developer devices.</span></span> <span data-ttu-id="d459d-514">在未來的更新/發行中，REST API 可能會變更。</span><span class="sxs-lookup"><span data-stu-id="d459d-514">The REST API is subject to change in future updates/releases.</span></span>

## <a name="more-information"></a><span data-ttu-id="d459d-515">詳細資訊</span><span class="sxs-lookup"><span data-stu-id="d459d-515">More information</span></span>

### <a name="watch-how-to-configure-a-kiosk-by-using-a-provisioning-package"></a><span data-ttu-id="d459d-516">觀看如何使用布建套件來設定 kiosk。</span><span class="sxs-lookup"><span data-stu-id="d459d-516">Watch how to configure a kiosk by using a provisioning package.</span></span>  

> [!VIDEO https://www.microsoft.com/videoplayer/embed/fa125d0f-77e4-4f64-b03e-d634a4926884?autoplay=false]

### <a name="global-assigned-access--kiosk-mode"></a><span data-ttu-id="d459d-517">全域指派的存取– Kiosk 模式</span><span class="sxs-lookup"><span data-stu-id="d459d-517">Global Assigned Access – Kiosk Mode</span></span>
- <span data-ttu-id="d459d-518">藉由啟用在系統層級套用 Kiosk 模式的新 Kiosk 方法，來減少 Kiosk 的身分識別管理。</span><span class="sxs-lookup"><span data-stu-id="d459d-518">Reduced Identity management for Kiosk, by enabling new Kiosk method that applies Kiosk mode at the system level.</span></span>

<span data-ttu-id="d459d-519">這項新功能可讓 IT 系統管理員針對多個應用程式 kiosk 模式設定適用于系統層級的 HoloLens 2 裝置，與系統上的任何身分識別沒有任何親和性，並適用于所有登入裝置的人。</span><span class="sxs-lookup"><span data-stu-id="d459d-519">This new feature allows an IT Admin to configure a HoloLens 2 device for multiple app kiosk mode which is applicable at system level, has no affinity with any identity on the system and applies to everyone who signs into the device.</span></span> <span data-ttu-id="d459d-520">如需這項新功能的詳細資訊，請參閱[HoloLens 全域指派的 access kiosk](hololens-global-assigned-access-kiosk.md)檔。</span><span class="sxs-lookup"><span data-stu-id="d459d-520">See the [HoloLens global assigned access kiosk](hololens-global-assigned-access-kiosk.md) documentation for more details on this new feature.</span></span>

### <a name="automatic-launch-of-an-application-in-multiple-app-kiosk-mode"></a><span data-ttu-id="d459d-521">以多應用程式 kiosk 模式自動啟動應用程式</span><span class="sxs-lookup"><span data-stu-id="d459d-521">Automatic launch of an application in multiple-app kiosk mode</span></span> 
- <span data-ttu-id="d459d-522">自動啟動應用程式的專注體驗，進一步增加為 Kiosk 模式體驗選擇的 UI 和應用程式選擇。</span><span class="sxs-lookup"><span data-stu-id="d459d-522">Focused experience with automatic app launch, further increasing the UI and app selections chosen for Kiosk mode experiences.</span></span>

<span data-ttu-id="d459d-523">只適用于多個應用程式 kiosk 模式，而只有1個應用程式可以指定為在指派的存取設定中使用下方反白顯示的屬性自動啟動。</span><span class="sxs-lookup"><span data-stu-id="d459d-523">Applies only to multiple-app kiosk mode and only 1 app can be designated to auto-launch using highlighted attribute below in Assigned Access configuration.</span></span> 

<span data-ttu-id="d459d-524">當使用者登入時，應用程式會自動啟動。</span><span class="sxs-lookup"><span data-stu-id="d459d-524">Application is automatically launched when user signs-in.</span></span> 
...
### <a name="kiosk-mode-behavior-changes-for-handling-of-failures"></a><span data-ttu-id="d459d-525">處理失敗的 Kiosk 模式行為變更</span><span class="sxs-lookup"><span data-stu-id="d459d-525">Kiosk mode behavior changes for handling of failures</span></span>
<span data-ttu-id="d459d-526">在套用 kiosk 模式失敗時，會出現下列行為：</span><span class="sxs-lookup"><span data-stu-id="d459d-526">Upon encountering failures in applying kiosk mode, the following behavior appears:</span></span>

- <span data-ttu-id="d459d-527">在 Windows 全息版之前，20H2 版 HoloLens 將會顯示 [開始] 功能表中的所有應用程式。</span><span class="sxs-lookup"><span data-stu-id="d459d-527">Prior to Windows Holographic, version 20H2 - HoloLens will show all applications in the Start menu.</span></span>
- <span data-ttu-id="d459d-528">Windows全像20H2 版-如果裝置的 kiosk 設定是全域指派的存取權和 AAD 群組成員指派的存取權，則如果判斷 AAD 群組成員資格失敗，使用者會看到 [開始] 功能表中顯示 [沒有任何內容]。</span><span class="sxs-lookup"><span data-stu-id="d459d-528">Windows Holographic, version 20H2 - if a device has a kiosk configuration which is a combination of both global assigned access and AAD group member assigned access, if determining AAD group membership fails, the user will see “nothing shown in start” menu.</span></span>

![Kiosk 模式在失敗時的外觀影像。](images/hololens-kiosk-failure-behavior.png )


- <span data-ttu-id="d459d-530">從 Windows 全像[21H1 版](hololens-release-notes.md#windows-holographic-version-21h1)，Kiosk 模式在顯示空的 [開始] 功能表之前，會先尋找全域指派的存取權。</span><span class="sxs-lookup"><span data-stu-id="d459d-530">Starting with [Windows Holographic, version 21H1](hololens-release-notes.md#windows-holographic-version-21h1), Kiosk mode looks for Global Assigned Access before showing an empty start menu.</span></span> <span data-ttu-id="d459d-531">如果在 AAD 群組 kiosk 模式期間發生失敗，則 kiosk 體驗將會回復為全域 kiosk 設定 (如果有) 。</span><span class="sxs-lookup"><span data-stu-id="d459d-531">The kiosk experience will fallback to a global kiosk configuration (if present) in case of failures during AAD group kiosk mode.</span></span>

### <a name="cache-azure-ad-group-membership-for-offline-kiosk"></a><span data-ttu-id="d459d-532">離線 Kiosk 的快取 Azure AD 群組成員資格</span><span class="sxs-lookup"><span data-stu-id="d459d-532">Cache Azure AD Group membership for offline Kiosk</span></span>

- <span data-ttu-id="d459d-533">在 Kiosk 模式失敗時排除可用的應用程式，以獲得更安全的 Kiosk 模式。</span><span class="sxs-lookup"><span data-stu-id="d459d-533">More secure Kiosk mode by eliminating available apps on Kiosk mode failures.</span></span>
- <span data-ttu-id="d459d-534">啟用可搭配 Azure AD 群組使用的離線 Kiosk，最多可達60天。</span><span class="sxs-lookup"><span data-stu-id="d459d-534">Enabled Offline Kiosks to be used with Azure AD groups for up to 60 days.</span></span>

<span data-ttu-id="d459d-535">此原則可控制將 Azure AD 群組成員資格快取用於指派給已登入使用者 Azure AD 群組之存取設定的天數。</span><span class="sxs-lookup"><span data-stu-id="d459d-535">This policy controls for how many days, Azure AD group membership cache is allowed to be used for Assigned Access configurations targeting Azure AD groups for signed in user.</span></span> <span data-ttu-id="d459d-536">一旦此原則值設定為大於0的值，則不會使用快取。</span><span class="sxs-lookup"><span data-stu-id="d459d-536">Once this policy value is set to value greater than 0 only then cache is used otherwise not.</span></span>  

<span data-ttu-id="d459d-537">名稱： AADGroupMembershipCacheValidityInDays URI 值：./Vendor/MSFT/Policy/Config/MixedReality/AADGroupMembershipCacheValidityInDays</span><span class="sxs-lookup"><span data-stu-id="d459d-537">Name: AADGroupMembershipCacheValidityInDays URI value: ./Vendor/MSFT/Policy/Config/MixedReality/AADGroupMembershipCacheValidityInDays</span></span>

<span data-ttu-id="d459d-538">最小值-0 天</span><span class="sxs-lookup"><span data-stu-id="d459d-538">Min - 0 days</span></span>  
<span data-ttu-id="d459d-539">最大-60 天</span><span class="sxs-lookup"><span data-stu-id="d459d-539">Max - 60 days</span></span> 

<span data-ttu-id="d459d-540">正確使用此原則的步驟：</span><span class="sxs-lookup"><span data-stu-id="d459d-540">Steps to use this policy correctly:</span></span> 
1. <span data-ttu-id="d459d-541">為以 Azure AD 群組為目標的 kiosk 建立裝置設定檔，並將其指派給 HoloLens 裝置 (s) 。</span><span class="sxs-lookup"><span data-stu-id="d459d-541">Create a device configuration profile for kiosk targeting Azure AD groups and assign it to HoloLens device(s).</span></span> 
1. <span data-ttu-id="d459d-542">建立自訂 oma-uri 型裝置設定，將此原則值設定為所需的天數 (> 0) ，並將它指派給 HoloLens 裝置 (s) 。</span><span class="sxs-lookup"><span data-stu-id="d459d-542">Create a custom OMA URI based device configuration which sets this policy value to desired number of days (> 0) and assign it to HoloLens device(s).</span></span> 
    1. <span data-ttu-id="d459d-543">URI 值應在 OMA-URI 文字方塊中輸入為./Vendor/MSFT/Policy/Config/MixedReality/AADGroupMembershipCacheValidityInDays</span><span class="sxs-lookup"><span data-stu-id="d459d-543">The URI value should be entered in OMA-URI text box as ./Vendor/MSFT/Policy/Config/MixedReality/AADGroupMembershipCacheValidityInDays</span></span>
    1. <span data-ttu-id="d459d-544">此值可介於 [允許的最小/最大值] 之間。</span><span class="sxs-lookup"><span data-stu-id="d459d-544">The value can be between min / max allowed.</span></span>
1. <span data-ttu-id="d459d-545">註冊 HoloLens 的裝置，並確認兩項設定會套用至裝置。</span><span class="sxs-lookup"><span data-stu-id="d459d-545">Enroll HoloLens devices and verify both configurations get applied to the device.</span></span> 
1. <span data-ttu-id="d459d-546">當網際網路可供使用時，讓 Azure AD 使用者1登入，一旦使用者登入和 Azure AD 群組成員資格確認成功，就會建立快取。</span><span class="sxs-lookup"><span data-stu-id="d459d-546">Let Azure AD user 1 sign-in when internet is available, once user signs-in and Azure AD group membership is confirmed successfully, cache will be created.</span></span> 
1. <span data-ttu-id="d459d-547">現在 Azure AD 使用者1可以讓 HoloLens 離線，並將其用於 kiosk 模式，只要原則值允許 X 天。</span><span class="sxs-lookup"><span data-stu-id="d459d-547">Now Azure AD user 1 can take HoloLens offline and use it for kiosk mode as long as policy value allows for X number of days.</span></span> 
1. <span data-ttu-id="d459d-548">您可以針對任何其他 Azure AD 使用者 N，重複執行步驟4和5。此處的重點是任何 Azure AD 使用者都必須使用網際網路登入裝置，至少一次我們可以判斷其是否為 Kiosk 設定目標 Azure AD 群組的成員。</span><span class="sxs-lookup"><span data-stu-id="d459d-548">Steps 4 and 5 can be repeated for any other Azure AD user N. Key point here is that any Azure AD user must sign-in to device using Internet so at least once we can determine that they are member of Azure AD group to which Kiosk configuration is targeted.</span></span> 
 
> [!NOTE]
> <span data-ttu-id="d459d-549">在針對 Azure AD 使用者執行步驟4之前，會遇到「已中斷連線」環境中提及的失敗行為。</span><span class="sxs-lookup"><span data-stu-id="d459d-549">Until step 4 is performed for a Azure AD user will experience failure behavior mentioned in “disconnected” environments.</span></span> 


## <a name="xml-kiosk-code-samples-for-hololens"></a><span data-ttu-id="d459d-550">HoloLens 的 XML Kiosk 程式碼範例</span><span class="sxs-lookup"><span data-stu-id="d459d-550">XML Kiosk Code Samples for HoloLens</span></span>

### <a name="multiple-app-kiosk-mode-targeting-an-azure-ad-group"></a><span data-ttu-id="d459d-551">以 Azure AD 群組為目標的多個應用程式 kiosk 模式。</span><span class="sxs-lookup"><span data-stu-id="d459d-551">Multiple app kiosk mode targeting an Azure AD group.</span></span> 
<span data-ttu-id="d459d-552">此 kiosk 會針對 Azure AD 群組中的使用者部署 Kiosk，他們會啟用包含3個應用程式的 Kiosk：設定、遠端協助和意見反應中樞。</span><span class="sxs-lookup"><span data-stu-id="d459d-552">This kiosk deploys a Kiosk that for users in the Azure AD group, they will have a Kiosk enabled that includes the 3 apps: Settings, Remote Assist, and Feedback Hub.</span></span> <span data-ttu-id="d459d-553">若要將此範例修改為立即使用，請務必變更下方反白顯示的 GUID，以符合您自己的 Azure AD 群組。</span><span class="sxs-lookup"><span data-stu-id="d459d-553">To modify this sample to be used immediately, make sure to change the GUID highlighted below to match an Azure AD Group of your own.</span></span> 


:::code language="xml" source="samples/kiosk-sample-multi-aad-group.xml" highlight="20":::


### <a name="multiple-app-kiosk-mode-targeting-azure-ad-account"></a><span data-ttu-id="d459d-554">以 Azure AD 帳戶為目標的多個應用程式 kiosk 模式。</span><span class="sxs-lookup"><span data-stu-id="d459d-554">Multiple app kiosk mode targeting Azure AD account.</span></span>
<span data-ttu-id="d459d-555">此 kiosk 會為單一使用者部署 Kiosk，他們會啟用包含3個應用程式的 Kiosk：設定、遠端協助和意見反應中樞。</span><span class="sxs-lookup"><span data-stu-id="d459d-555">This kiosk deploys a Kiosk for a single user, they will have a Kiosk enabled that includes the 3 apps: Settings, Remote Assist, and Feedback Hub.</span></span> <span data-ttu-id="d459d-556">若要將此範例修改為立即使用，請務必變更下方反白顯示的帳戶，以符合您自己的 Azure AD 帳戶。</span><span class="sxs-lookup"><span data-stu-id="d459d-556">To modify this sample to be used immediately, make sure to change the account highlighted below to match an Azure AD Account of your own.</span></span> 
