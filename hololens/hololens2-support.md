...
ms.locfileid: "124428395"
---
# <a name="what-are-the-mixed-reality-support-and-help-options"></a>有哪些混合現實支援和協助選項？

您是否想要在開發應用程式時解除封鎖，或有 HoloLens 2 或 Windows Mixed Reality 耳機的問題？ 或許您正在使用 Azure mixed reality 服務，並有技術方面的問題。 
...
- 從[Microsoft Q&A](#post-a-question-on-microsoft-qa)的社區取得 HoloLens 2 程式設計協助
- 深入瞭解[Azure mixed reality 服務](#azure-mixed-reality-services-support)的 [說明 + 支援] 和 [服務健康狀態]
- 在[MR 支援](https://aka.ms/mrsupport)中建立 HoloLens 2 或沉浸式耳機程式設計的支援要求 
- 針對 HoloLens 2 裝置問題建立支援要求，包括硬體、使用 & configuration [HoloLens 2 裝置支援](https://aka.ms/hlsupport) 
...
>[!Note]
>您可以使用下列其中一個商業支援公司電話號碼來協助您完成購買。 

>[!Note]
>如果您是從下面未列出的市場取得支援，請將您的來電導向我們的美國企業服務中心號碼。

| 市場 | 公司服務中心號碼 | 作業時數 |
|-----------------|-------------------|-----------------------|
| 英國 | + 44 800 026 0061 | 週一到週五，09AM 到下午6點 |
| 德國 | + 49 08 05 98 00 03 | 週一到週五，09AM 到下午6點 |
| 瑞典    | + 46 20 120 3222   | 週一到週五，09AM 到下午6點 |
| 瑞士 | + 41 800 662006 |    週一到週五，09AM 到下午6點 |
| 比利時 | + 32 80058153 |  週一到週五，09AM 到下午6點 |
| 荷蘭 | + 31 8007482055 |    週一到週五，09AM 到下午6點 |
| 奧地利 | + 43 800 943670 |    週一到週五，09AM 到下午6點 |
| 丹麥 | + 45 80400184 |  週一到週五，09AM 到下午6點 |
| 愛爾蘭 | + 353 1800 832 653 | 週一到週五，09AM 到下午6點 |
| 義大利 |   + 39 800598979 | 週一到週五，09AM 到下午6點 |
| 盧森堡 |  + 352 80040425 | 週一到週五，09AM 到下午6點 |
| 西班牙 |    + 34 800 598979 |   週一到週五，09AM 到下午6點 |
| 挪威 |  + 47 80062002 |  週一到週五，09AM 到下午6點 |
...
>[!IMPORTANT]
>如果您需要完整的 加值稅 發票，您應該直接與商業支援商店小組聯繫，而不是在線上購買裝置。 所有線上購買產品將只會收到簡化的 加值稅 發票，但稍後無法編輯。

## <a name="azure-mixed-reality-services-support"></a>Azure mixed reality 服務支援

### <a name="open-an-azure-portal-technical-support-ticket"></a>開啟 Azure 入口網站技術支援票證

若要在 Azure 空間錨點、Azure 物件錨點或 Azure 遠端轉譯的 Azure 入口網站上開啟技術支援票證：
...
3. 完成支援票證欄位時：
    ...
    2. 盡可能以精確且詳細的方式填滿表單，以及您慣用的方法。

    3. 檢查您在上一節中填寫的所有資訊，並立即提交支援要求。
...
>[!Note]
>提供意見反應是讓您的聲音聽得很好的方式，不過意見反應並不是接收回應的方式。 意見反應中樞可以與其他支援選項結合。
