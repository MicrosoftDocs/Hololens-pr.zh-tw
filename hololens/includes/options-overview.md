...
## 1. 快速入門
您可以在商務用商業環境中選擇使用這些裝置。 這些裝置可以設定為適合任何開發人員或組織的功能。 

每個 HoloLens 2 版都有相同的硬體，即 [包裝盒中](../hololens2-hardware.md#hololens-components) 的相同內容，並隨附相同的 [預先安裝軟體](../hololens2-hardware.md#pre-installed-software)。

## 2. 在您的組織中部署 HoloLens 裝置
本節將讓您和您的組織準備好部署 HoloLens 裝置。 

### 準備
| 以來  | 負面  |
|---|---|
| [在商業環境中部署 HoloLens](../hololens-requirements.md)。   | 您學到了考慮事項。  |
| 考慮您的 [基礎結構部署](../common-scenarios.md)。  | 您已評估您的基礎結構。  |
| 考慮您的裝置要使用的身分 [識別](../hololens-identity.md) 。  | 您知道您所挑選的身分識別，且有限制。   |
...
| 以來  |  負面  |
|---|---|
| [管理 HoloLens 更新](../hololens-updates.md)。  | 您瞭解如何管理裝置的更新。   |
| 針對任何問題[進行疑難排解](../hololens-troubleshooting.md)。  | 您知道為什麼要移至哪裡來排查 HoloLens 問題。   |

## 3. 探索解決方案

| 解決方案 | 簡短描述                                                                                |
|----------|---------------------------------------------------------------------------------------------------|
| [HoloLens 的 Dynamics 365](https://www.microsoft.com//hololens/apps)          | 為員工準備並優化作業。                                                        |
| [Dynamics 365 Remote Assist](https://dynamics.microsoft.com/mixed-reality/remote-assist/)          | 透過不同位置共同作業，讓技術人員更有效率地進行共同作業。 |
|   [Dynamics 365 Guides](https://dynamics.microsoft.com/mixed-reality/guides/)        | 改善訓練的需求，並瞭解員工的實際執行情況。                          |
|  [針對混合式現實的 Azure 雲端服務](https://docs.microsoft.com/windows/mixed-reality/develop/mixed-reality-cloud-services#:~:text=Mixed%20Reality%20services%20Mixed%20Reality%20cloud%20services%20like,all%20in%20the%20context%20of%20your%20users%E2%80%99%20environments)         | 瞭解如何使用 Azure 雲端服務開發解決方案。                                       |
|  [開始針對 HoloLens 2 進行開發](https://docs.microsoft.com/windows/mixed-reality/develop/development?tabs=unity)         | 建立符合您需求的混合式真實方案。                                                 |

## 其他資源

### 設定個別裝置
1. [讓您的裝置準備好使用](https://docs.microsoft.com/hololens/hololens2-setup) ，然後 [取得設定](https://docs.microsoft.com/hololens/hololens2-start)。
1. [瞭解如何在 HoloLens 2 周圍找到](https://docs.microsoft.com/hololens/holographic-home)。
1. &#39;您的體驗之後，請 [採取一些混合現實相片或](https://docs.microsoft.com/hololens/holographic-photos-and-videos)影片。
1. [在 Microsoft Store app 上查看所有適用于 HoloLens 2 的可用應用程式](https://docs.microsoft.com/hololens/holographic-store-apps)。
...
# [HoloLens 2 含 Dynamics 365 遠端協助](#tab/remoteassist)

## 1. 透過 Dynamics 365 遠端協助瞭解 HoloLens 2
- 您可以在商務用商業環境中選擇使用這些裝置。 依您的需求順序排列。
- 在企業環境中，最常使用 HoloLens 的其中一個用途，就是使用遠端協助的能力。 使用這個選項時，您會在 (每個裝置) 中取得一個座位授權。
...
|----------|---------------------------------------------------------------------------------------------------|
| [HoloLens 的 Dynamics 365](https://www.microsoft.com//hololens/apps)          | 為員工準備並優化作業。                                                        |
|   [Dynamics 365 Guides](https://dynamics.microsoft.com/mixed-reality/guides/)        | 改善訓練效能，並瞭解員工的執行方式。                          |
|  [針對混合式現實的 Azure 雲端服務](https://docs.microsoft.com/windows/mixed-reality/develop/mixed-reality-cloud-services#:~:text=Mixed%20Reality%20services%20Mixed%20Reality%20cloud%20services%20like,all%20in%20the%20context%20of%20your%20users%E2%80%99%20environments)         | 瞭解如何使用 Azure 雲端服務開發解決方案。                                       |
|  [開始針對 HoloLens 2 進行開發](https://docs.microsoft.com/windows/mixed-reality/develop/development?tabs=unity)         | 建立符合您需求的混合式真實方案。                                                 |


# [HoloLens 2 開發版本](#tab/developeredition)
...
|  [適用于 Unity 的 Pixyz 外掛程式](https://www.pixyz-software.com/plugin/) | 將工程 &amp; CAD 世界與開發世界連接在一起的橋樑。   |
| [Azure 服務的 Azure 點數 $500](https://azure.microsoft.com/resources/) | HoloLens 2 開發版本隨附的 Azure 點數是快速開始在 Azure 上建立及測試混合式現實應用程式。 |
...
如何兌換 Azure 信用：若要兌換您的 $500 Azure 點數，請兌換您的 Azure Pass 促銷代碼並啟用您的訂閱。 [深入了解。](../hololens2-development-edition-faq.md#how-can-i-redeem-my-500-azure-credit)

- [瞭解 Azure 空間錨點如何協助您建立地圖、共用及保持3D 內容的應用程式](https://azure.microsoft.com/services/spatial-anchors/)
- [瞭解 Azure 遠端轉譯如何轉譯高品質、互動式3D 內容，以及即時將其流式資料流程至您的裝置](https://azure.microsoft.com/services/remote-rendering/)
