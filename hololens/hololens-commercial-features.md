...
description: 瞭解企業的 Microsoft HoloLens 商業功能，以管理 HoloLens 裝置。
author: qianw211
ms.author: v-qianwen
ms.date: 9/1/2021
ms.custom:
...
ms.locfileid: "126035778"
---
# <a name="hololens-2-capabilities-and-solutions"></a>HoloLens 2 的功能與解決方案

## <a name="why-hololens"></a>為什麼 HoloLens？

由於有 HoloLens 2 和混合的現實應用程式，現在工作者可以在沒有界限的情況下共同作業、有效地採取行動並提高生產力。

在不使用界限的情況下共同作業，並在 HoloLens 2 上以混合現實應用程式提高員工生產力。 使用內建的語音命令、眼睛追蹤和世界錨定，持續專注于安全地完成工作而不會發生錯誤，持續掌握最新狀態、使用內建語音命令、眼睛追蹤和世界錨定。 與遠端同事即時連線，並在您的實體環境中廣泛的全像重迭畫布上合作，在工作時間點快速解決問題。 利用 Microsoft 的安全性、可靠性和擴充性所支援的強大應用程式生態系統，來實現投資報酬率 (ROI) 立即現成。  

我們希望這篇文章激勵您思考混合現實 (MR) 將對您的業務有利的所有方法。
...
| 手勢追蹤 | 以自然的方式觸控、抓住和移動全息影像。 HoloLens 2 符合您的手新發現分享對您互動的滿意度。 |
...
## <a name="how-hololens-2-is-transforming-industries"></a>HoloLens 2 如何轉換產業
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="eatons-vehicle-group-uses-dynamics-365-mixed-reality-to-drive-savings-efficiencies"></a>[Eaton 的車輛群組使用 Dynamics 365 mixed reality 來推動節省成本和效率。](https://customers.microsoft.com/en-us/story/1406696349549504197-eaton-vehicle-group-dynamics-365-mixed-reality)
        「當您描述問題時，請想像我們說的是不同的語言。 當您說明它時，另一端的人可能無法精確地瞭解發生的情況，但當您在 HoloLens 中即時顯示時，人們也瞭解。」 <br> -Alexandre M. Moraes： Eaton 的工廠經理。
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="sheba-medical-center-uses-microsofts-hololens-for-ventilators-training"></a>[Sheba 醫療中心使用 Microsoft 的 HoloLens 進行 ventilators 訓練。](https://customers.microsoft.com/en-us/story/1388628932382960935-sheba-health-provider-azure-en-israel)
        Sheba 醫療中心的員工使用 HoloLens 來訓練護士和其他支援人員，以使用在 covid-19-19 流感期間部署的 ventilator 電腦。
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="zf-builds-agile-facility-at-gray-court-with-microsoft-365-improves-operational-equipment-efficiency"></a>[ZF 以灰色法院的 Microsoft 365 建立 agile 設備，並提升營運設備的效率。](https://customers.microsoft.com/en-us/story/1341470537472393895-zfgroup-gray-court-chapter-automotive-microsoft365)
        針對 ZF 群組，Microsoft 365 可協助其員工即時共用知識、進行疑難排解並進行通訊。 
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="tokyu-construction-improves-engineering-precision-and-increases-productivity-with-azure-remote-rendering-on-hololens-2"></a>[Tokyu 建築可改善工程的精確度，並透過 HoloLens 2 的 Azure 遠端轉譯來提高生產力。](https://customers.microsoft.com/en-us/story/1333933369626897988-tokyu-construction-manufacturing-azure-holo-lens-2)
        除非您是經過定型的架構工程師，否則查看2D 藍圖可能會很困難，並且將建築物在3D 中的實際外觀視覺化。 
    :::column-end:::
:::row-end:::
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        ### <a name="mda-takes-mixed-reality-into-orbit-with-hololens-2"></a>[MDA 會在 HoloLens 2 的過程中，使用混合的事實。](https://customers.microsoft.com/en-us/story/1377057233739728271-mda-manufacturing-hololens-canada)
        MDA 使用沉浸式混合現實體驗來協助工程師將設計視覺化、加速診斷問題，以及訓練 astronauts 和地面控制器。
    :::column-end:::
:::row-end:::
<br>
...
在我的組織中管理 HoloLens 裝置 | [**Mobile 裝置管理**](hololens-mdm-configure.md) | 管理設定、選取要安裝的應用程式，以及針對您組織在多個 HoloLens 2 裝置上的需求，從中央位置進行量身打造的安全性設定。 | 
|將新使用者和裝置的設定時間降到最低 | [**自動駕駛儀**](hololens2-autopilot.md) | 在 Microsoft 端點管理員中設定 (OOBE) 的全新體驗，並讓終端使用者在幾乎不需要互動的情況之下，準備裝置以供企業使用。 |  
...
| 管理裝置連接到網際網路的方式 | [**網路與連線能力**](hololens-certificates-network.md) | 使用以憑證為基礎的驗證來存取 Wi-fi、Vpn 或內部資源。 | 
