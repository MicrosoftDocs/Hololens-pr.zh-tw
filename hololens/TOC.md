...
#### [新增設定應用程式](hololens-new-settings.md)
#### [新增 Microsoft Edge](hololens-new-edge.md)
### 管理應用程式
#### [尋找、安裝及卸載 store 應用程式](holographic-store-apps.md)
...
# 部署 HoloLens 2
## [一般部署案例](hololens-requirements.md)
## [規劃 HoloLens 2 部署](hololens-core-components.md)
## 部署指南
### 雲端連線環境部署指南
#### [概觀](hololens2-cloud-connected-overview.md)
#### [準備](hololens2-cloud-connected-prepare.md)
#### [設定](hololens2-cloud-connected-configure.md)
#### [部署](hololens2-cloud-connected-deploy.md)
#### [保持](hololens2-cloud-connected-maintain.md)
#### [外部用戶端](hololens2-deployment-guide.md)
### 公司網路部署指南
#### [概觀](hololens2-corp-connected-overview.md)
#### [準備](hololens2-corp-connected-prepare.md)
#### [設定](hololens2-corp-connected-configure.md)
#### [部署](hololens2-corp-connected-deploy.md)
#### [保持](hololens2-corp-connected-maintain.md)
...
### [架構](security-architecture.md)
### [狀態隔離和隔離](security-state-separation-isolation.md)
### [無系統管理的作業系統 ](security-adminless-os.md)
### [限制密碼使用](security-limiting-password-use.md)
### [硬體支援的安全性與執行時間證明](security-hardware-backed-integrity.md)
### [加密和資料保護](security-encryption-data-protection.md)
### [網路安全性](security-network-security.md)
### [安全性工程 ](security-engineering.md)
### [HoloLens 2隱私權與資料保護](hololens2-privacy.md)
## 註冊裝置
### [在 MDM 中註冊 HoloLens](hololens-enroll-mdm.md)
### [適用於 HoloLens 2 的 Windows Autopilot](hololens2-autopilot.md) 
### [註冊受限 Wi-Fi 環境中的 MAC 位址](mac-address-options.md)
## 應用程式部署
### [應用程式管理總覽](app-deploy-overview.md)
### [Intune & 公司入口網站](app-deploy-intune.md)
### [商務用 Microsoft Store](app-deploy-store-business.md)
### [布建套件](app-deploy-provisioning-package.md)
